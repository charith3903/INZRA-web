  ...
  <div class="cs_swiper_parallax_slider_wrap">
    ...
    <div class="cs_moving_wrap background-filled text-uppercase text-white d-flex align-items-center" data-src="{{ asset('assets/img/moving_text_shape.png') }}">
      <div class="cs_moving_text cs_fs_30 cs_fs_lg_26 d-flex align-items-center text-nowrap">
        <span>* Creative Web Designing</span>
        {{-- <span>* Innovation Creative Design </span> --}}
        <span>* Search Engine Optimization</span>
        <span>* Artificial Intelligence</span>
        <span>* Social Media Marketting</span>
      </div>
          ...
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="{{ asset('assets/img/service_3.jpg') }}"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
